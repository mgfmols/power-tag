...
public class GameBonusPointComparator implements Comparator<GamePlayer>
{
    @Override
    public int compare(GamePlayer o1, GamePlayer o2)
    {
        ...
        ArrayList<GameSortingType> checkOrder = ComparatorChecker.getCompareOrder(GameSortingType.Bonuspoints);
